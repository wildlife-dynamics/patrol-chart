...
from ecoscope.platform.tasks.config import (
    get_chart_time_interval as get_chart_time_interval,
)
from ecoscope.platform.tasks.config import set_chart_config as set_chart_config
...
from ecoscope.platform.tasks.config import get_chart_figures as get_chart_figures
...
from ecoscope.platform.tasks.config import set_chart_style as set_chart_style
...
def main(params: dict[str, Any], validate_params_schema: bool = True):
    ...
    set_chart_title = (
        ...
        .partial(var="Patrol Chart", **(params.get("set_chart_title") or {}))
        .call()
    )

    trend_config = (
        task(set_chart_config)
        .validate()
    ...
    chart_figures = (
        task(get_chart_figures)
        .validate()
        .set_task_instance_id("chart_figures")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
